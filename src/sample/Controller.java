...
public class Controller {
	...
	public void initialize() {
		...
		/*
		pane1.setStyle("-fx-background-image: url('sample/bs1.jpg')");
		pane2.setStyle("-fx-background-image: url('sample/bs2.jpg')");
		pane3.setStyle("-fx-background-image: url('sample/bs3.jpg')");
		pane4.setStyle("-fx-background-image: url('sample/bs4.jpg')");
*/
		backgroundAnimation();
